...
class TrafficStateABCSTNDataset(TrafficStateDataset):
    ...
    def _load_rel(self):
        ...
        """
        super()._load_rel()
        Mor_mx = np.load(self.data_path + self.rel_file + '.mor.npy')
        self.Mor_mx = Mor_mx
        self._logger.info('load mapping matrix Mor_mx: {}'.format(self.Mor_mx.shape))
